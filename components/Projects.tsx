                 ...
                 p-6 rounded-2xl bg-white drop-shadow-2xl overflow-y-auto">
                    ...
                    <div className="flex flex-col items-center md:block">
                        ...
                        <div className="flex flex-col md:flex-row md:justify-center items-center px-10 sm:px-0 w-full sm:w-auto">
                            <a href="#" target="_blank" className="text-center w-full sm:w-auto m-2"><Button style={'secondary'} content={'Github'} /></a>
                            <a href="#" target="_blank" className="text-center w-full sm:w-auto m-2"><Button style={'secondary'} content={'Live Demo'} /></a>
                        </div>
                    </div>
                </div>
            )}
